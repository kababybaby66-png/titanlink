...
class WebRTCService {
    ...
    getConnectionQuality(): {
        ...
        return {
            ...
            jitter: this.connectionQuality.jitter,
            networkQuality: this.connectionQuality.networkQuality,
            hasAudio: this.connectionQuality.hasAudio,
            bitrateMbps: this.connectionQuality.currentBitrate,
        };
    }
    ...
    getOutgoingBitrate(): number {
        return 0; // Not actively tracked in WebRTC implementation yet
    }
